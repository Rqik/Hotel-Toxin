...
class DatePicker {
  constructor() {
    this.props = {
      ...
      onSelect(fd, date, picker) {
        ...
        el.children('.js-data-select__input_left')
          .val(fd.split(',')[0]);
        el.children('.js-data-select__input_right')
          .val(fd.split(',')[1]);
      },
    };
    this.propsRange = {
  ...
  init() {
    $('.js-date-picker__input,  .js-date-select__input_range ')
      .each(this.addClassDatePicker.bind(this));
    $('.js-data-select__label')
      .click(this.showSelectLabel);
    $('.js-data-select__input_left')
      .change(this.changeSelectInput);
    $('.js-data-select__input_right')
      .change(this.changeSelectInput);

    $('.js-data-select__input')
      .mask('00.00.0000');
